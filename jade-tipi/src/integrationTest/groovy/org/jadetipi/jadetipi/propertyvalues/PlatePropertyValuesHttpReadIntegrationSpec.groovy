...
class PlatePropertyValuesHttpReadIntegrationSpec extends Specification {
    ...
    def 'the projected loc property values and the inherited effective properties read back over HTTP'() {
        ...
        webTestClient.get().uri('/api/locations/{id}/property-values', plateLocId)
                ...
                .expectStatus().isOk()
                .expectBody()
                .jsonPath('$.objectId').isEqualTo(plateLocId)
                .jsonPath('$.collection').isEqualTo('loc')
                .jsonPath('$.typeId').isEqualTo(plate96TypeId)
                .jsonPath('$.properties.name').isEqualTo('demo plate 0001')
                .jsonPath("\$.propertyValues['${barcodePropertyId}'].propertyName").isEqualTo('barcode')
                .jsonPath("\$.propertyValues['${barcodePropertyId}'].value.text").isEqualTo('PLATE-BC-0001')
                .jsonPath("\$.propertyValues['${barcodePropertyId}'].txnId").isEqualTo(txnId)
                .jsonPath("\$.propertyValues['${barcodePropertyId}'].commitId").isNotEmpty()
                .jsonPath("\$.propertyValues['${barcodePropertyId}'].appliedAt").isNotEmpty()
        ...
        webTestClient.get().uri('/api/types/{id}/effective-properties', plate96TypeId)
                ...
                .expectBody()
                .jsonPath('$.typeId').isEqualTo(plate96TypeId)
                .jsonPath('$.typeName').isEqualTo('plate_96_well')
                .jsonPath('$.chainComplete').isEqualTo(true)
                .jsonPath('$.typeChain[0]').isEqualTo(plate96TypeId)
                .jsonPath('$.typeChain[1]').isEqualTo(plateTypeId)
                .jsonPath('$.typeChain[2]').isEqualTo(containerTypeId)
                .jsonPath("\$.effectiveProperties['${barcodePropertyId}'].sourceTypeId").isEqualTo(containerTypeId)
                .jsonPath("\$.effectiveProperties['${barcodePropertyId}'].propertyName").isEqualTo('barcode')
