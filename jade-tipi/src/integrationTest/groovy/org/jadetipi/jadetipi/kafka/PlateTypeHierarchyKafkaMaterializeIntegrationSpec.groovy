...
class PlateTypeHierarchyKafkaMaterializeIntegrationSpec extends Specification {
    ...
    def setup() {
        ...
        barcodePropertyId = "jadetipi-itest-plate96~ppy~barcode_${featureUuid}"
        unregisteredPropertyId = "jadetipi-itest-plate96~ppy~volume_${featureUuid}"
        containerTypeId = "jadetipi-itest-plate96~typ~container_${featureUuid}"
        plateTypeId = "jadetipi-itest-plate96~typ~plate_${featureUuid}"
        plate96TypeId = "jadetipi-itest-plate96~typ~plate_96_well_${featureUuid}"
        plateLocId = "jadetipi-itest-plate96~loc~plate_0001_${featureUuid}"
    }
