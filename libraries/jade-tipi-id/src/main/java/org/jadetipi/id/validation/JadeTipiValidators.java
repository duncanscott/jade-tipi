...
public final class JadeTipiValidators {
    ...
    public static boolean isPrefix(String s) {
        return s != null && P_PREFIX.matcher(s).matches();
    }

    public static boolean isTimestamp(String s) {
        return s != null && P_TS.matcher(s).matches();
    }

    public static boolean isSequence(String s) {
        return s != null && P_SEQ.matcher(s).matches();
    }

    public static boolean isUuid(String s) {
        return s != null && P_UUID.matcher(s).matches();
    }

    public static boolean isType(String s) {
        return s != null && P_TYPE.matcher(s).matches();
    }
}
